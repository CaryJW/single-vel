package cc.cary.vel.monitor.services.impl;

import cc.cary.vel.common.libs.QueryRequest;
import cc.cary.vel.common.utils.AddressUtils;
import cc.cary.vel.common.utils.VelFileUtils;
import cc.cary.vel.common.utils.QueryUtils;
import cc.cary.vel.monitor.entities.Log;
import cc.cary.vel.monitor.mapper.LogMapper;
import cc.cary.vel.monitor.services.ILogService;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, Log> implements ILogService {
  ...
  public void saveLog(ProceedingJoinPoint point, Log log) {
    ...
    cc.cary.vel.common.annotation.Log logAnnotation = method.getAnnotation(cc.cary.vel.common.annotation.Log.class);
  ...
  public void export(Map<String, Object> params, HttpServletResponse response) {
    try {
      ...
      log.error("系统日志导出失败：{}", e.getMessage());
    }
  }
